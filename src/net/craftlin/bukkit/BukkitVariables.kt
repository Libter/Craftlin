...
class BukkitVariables(private val plugin: JavaPlugin, listener: Listener, commands: Commands<BukkitCommandContext>):
    Variables<BukkitCommandContext>(listener, commands) {
